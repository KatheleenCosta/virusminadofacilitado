...
const phaseSixLostFinal = document.querySelector('#phaseSixLostFinal')
const tryAgainP6Final = document.querySelector('#tryAgainP6Final')
...
function gameOver() {
  for (var i = 0; i < cols; i++) {
    for (var j = 0; j < rows; j++) {
      ...
      phaseSixLostFinal.style.display = 'block'

      tryAgainP6Final.addEventListener('click', () => {
        setup();
        contaAbertas = 0;
        gameOverBlock = false;
        userLost = false;
